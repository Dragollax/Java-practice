...
/*
   ...
   Description:
      ...
      the array that add up to 0. In other words, all the zero sum sub arrays. Secondly, the program will find the smallest sub array length
      ...
      given that you can replace k amount of zeroes.
